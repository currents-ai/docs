...
You can edit or delete reports if you're an ['admin'](/user-roles). Editing or deleting reports is straight forward.
...
Note - You'll only see this button if you're an ['admin'](/user-roles).
