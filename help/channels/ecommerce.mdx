...
- You can change the name of the data source in the "Name" field.
- To add a new source, click the "+ Add New Items" button and select existing sources from the RHS panel.
- To remove a source, click the "X" button next to the source you want to remove.
- After making the necessary changes, click the "Finish" button to save the updates to your data source.

![edit-data-source](/img/help/edit-data-source.png)
